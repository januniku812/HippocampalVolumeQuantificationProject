**Hippocampal Volume Quantification project**
This is my completed Hippocampal Volume Quantification Project from the Udacity AI in Healthcare Nanodegree that has been uploaded as a tar.gz file due to GitHub not allowing large quantities of files. In order to open this first download the tar.gz file. Then follow the next steps for extraction & execution. 
The explanation for this project is bellow the 'How to Open and Run the Project' section.
...
First, extract the contents of the `.tar.gz` file. Depending on your operating system, follow these instructions:

#### On Linux or macOS:

Open your terminal and navigate to the directory where your `.tar.gz` file is located, then run:
...
2. **Using Command Prompt or PowerShell:**
   - Install a tool like [7-Zip](https://www.7-zip.org/) or [WinRAR](https://www.rarlab.com/download.htm).
   - Right-click the file and use the tool's context menu to extract it.

### 2. Navigate to the Project Directory

Once extracted, navigate to the project directory in your terminal or command prompt:
...
Depending on the project requirements, set up your environment and install dependencies:
...
Depending on the project files, use the following methods:

#### For Python Scripts:

Run Python scripts (e.g., `main.py`) with:
...
This will open a web interface where you can navigate to and open your `.ipynb` files.

### 5. Follow Project-Specific Instructions

Check for any additional instructions in files like `README.md` or `INSTALL.md` included in the project for specific setup and running instructions.

---

Feel free to adjust the placeholder names (`yourfile.tar.gz`, `path/to/extracted/folder`, `your_environment_name`) to match your actual file names and paths.

**Project Explaination: The following explanation for this project has been pulled from the Udacity starter code for this project as I believe it explains the components of this project well.**
# Final Project Instructions

This file contains background information and instructions for the final project **taken directly from the Udacity Nanodegree Project pags**
